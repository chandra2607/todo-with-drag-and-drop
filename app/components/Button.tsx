...
export function Button({ children, onClick, variant = "secondary", className = "" ,...rest}: ButtonProps) {
  ...
  return (
    <button {...rest} onClick={onClick} className={`${baseClasses} ${variantClasses} ${className}`}>
      {children}
    </button>
  )
}
